...
import speakerHelper from './speaker-helper';
...
export default class Assistant extends EventEmitter {
    ...
    startedConversation(conversation) {
        ...
        const speaker = new Speaker({
            channels: 1,
            sampleRate: this.options.conversation.audio.sampleRateOut,
        });
        ...
        speaker
            ...
            .on('close', () => {
                ...
                if (this.openMicAgain) this.assistant.start(this.options.conversation);
            });
